...
> = {
  ...
  ja: {
    ...
    intro:
      "新規症例の送信、納期の確認、再注文のすべてを一か所で。Portal を使い始めるために必要なことをまとめました。",
    whyHeading: "Portal を使うメリット",
    why: [
      {
        title: "リアルタイムで注文を追跡",
    ...
    steps: [
      {
        label: "①",
        title: "サインイン",
        body: "「Continue with Google」が一番早いです。または招待メールからパスワードを設定してください。",
      },
      {
        label: "②",
        title: "注文を確認する",
      ...
      },
      {
        label: "③",
        title: "新規症例を送信する",
        body: "「Submit Case」をクリック。STL を添付し、歯式図に印を入れ、装置の詳細を選んで送信するだけです。",
      },
      {
        label: "④",
        title: "過去の症例から再注文する",
      ...
      },
      {
        label: "⑤",
        title: "症例について質問する",
        body: "どの注文画面からも「Ask about this case」が使えます。メッセージは注文に紐付いて担当者に届きます。",
      },
    ],
    closing:
      "今後の新規症例はぜひ Portal からお送りください。すべての症例履歴が一か所にまとまり、納期もつねに最新の状態でご確認いただけます。",
