...
export const TRADITIONAL_COLORS: ColorOption[] = [
  { id: 1, name: "Pink", hex: "#F08AB0", category: "traditional" },
  { id: 2, name: "Clear", hex: "#E5E7EB", category: "traditional" },
  { id: 3, name: "Orange", hex: "#F97316", category: "traditional" },
  { id: 4, name: "Yellow", hex: "#FACC15", category: "traditional" },
  { id: 5, name: "Green", hex: "#84CC16", category: "traditional" },
  { id: 6, name: "Light Blue", hex: "#38BDF8", category: "traditional" },
  { id: 16, name: "Blue", hex: "#2563EB", category: "traditional" },
  { id: 17, name: "Red", hex: "#DC2626", category: "traditional" },
  { id: 18, name: "Black", hex: "#0F172A", category: "traditional" },
  { id: 19, name: "Purple", hex: "#C026D3", category: "traditional" },
  { id: 20, name: "White", hex: "#FFFFFF", category: "traditional" },
];

export const GLITTER_COLORS: ColorOption[] = [
  { id: 21, name: "Blue Glitter", hex: "#7DD3FC", category: "glitter" },
  { id: 22, name: "Silver Glitter", hex: "#D4D4D8", category: "glitter" },
  { id: 23, name: "Aqua Glitter", hex: "#A5F3FC", category: "glitter" },
  { id: 24, name: "Purple Glitter", hex: "#E9D5FF", category: "glitter" },
  { id: 25, name: "Orange Glitter", hex: "#FED7AA", category: "glitter" },
  { id: 26, name: "Multi Glitter", hex: "#F4F4F5", category: "glitter" },
  { id: 27, name: "Red Glitter", hex: "#FCA5A5", category: "glitter" },
  { id: 28, name: "Gold Glitter", hex: "#FEF08A", category: "glitter" },
];

export const NEON_COLORS: ColorOption[] = [
  { id: 31, name: "Neon Glow", hex: "#F0F9D8", category: "neon" },
  { id: 32, name: "Neon Pink", hex: "#F0309F", category: "neon" },
  { id: 33, name: "Neon Orange", hex: "#FF6A1F", category: "neon" },
  { id: 34, name: "Neon Red", hex: "#FF3030", category: "neon" },
  { id: 35, name: "Neon Blue", hex: "#1F8FFF", category: "neon" },
  { id: 36, name: "Neon Yellow", hex: "#E5F23C", category: "neon" },
  { id: 37, name: "Neon Green", hex: "#3FE651", category: "neon" },
  { id: 38, name: "Neon Teal", hex: "#0E9F84", category: "neon" },
  { id: 39, name: "Neon Purple", hex: "#A30FA3", category: "neon" },
];
